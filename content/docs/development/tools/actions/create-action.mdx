...
Create a new file within your app's action folder. Call it something like `new-action.app.ts`. Make sure it ends with `.action.ts`. Make sure the name is descriptive of the action yet succinct.
...
5. Add an AI Schema
   ...
   Read more about the [AI Schema](/docs/development/ai-schema).
...
6. Add an Input Config
   ...
   <Callout>
     Read more about the [Input Config](/docs/development/input-config)
   </Callout>
