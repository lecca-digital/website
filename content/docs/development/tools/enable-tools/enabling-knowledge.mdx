...
<Callout>
  Roadmap Item: Use [Chroma](https://www.trychroma.com/) to embed and store data
  locally without S3 or Pinecone
</Callout>
...
We currently use S3, OpenAI's embedding model, and Pinecone to operate knowledge notebooks. We have plans to support [Chroma](https://www.trychroma.com/) for local embedding and vector storage.
