...
function HomeHero() {
  return (
    <main className="h-full flex flex-1 flex-col items-center justify-center text-center space-y-8 lg:space-y-12 py-10 md:py-32 lg:py-40 px-4">
      <div className="flex flex-col items-center space-y-6 max-w-[700px]">
        <h1 className="text-2xl md:text-5xl font-extrabold">
          <span>Automate Your Business</span>
          <br />
          <span>with an </span>
          <span>
            <span className="text-blue-500 font-serif">AI Workforce</span>
          </span>
        </h1>
        <h2 className="md:text-2xl opacity-0 animate-fade-in-delayed-1s">
          <span>
            Let your <span className="font-serif font-semibold">AI Agents</span>{" "}
            do the boring stuff
          </span>
          <br />
        </h2>
      ...
      <div className="max-w-[900px] rounded-3xl overflow-hidden shadow-md border-4">
        <video
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        <Button
          asChild
          className="opacity-0 animate-fade-in-delayed-1s py-7 text-md"
          size="lg"
        >
          <Link href="https://app.lecca.io">Get started for free</Link>
        </Button>
        <Button
          variant="ghost"
          asChild
          className="opacity-0 animate-fade-in-delayed-1.5s py-7 text-md"
          size="lg"
        >
          <Link href="/docs/overview" className="space-x-1">
            <span>Documentation</span>
            <ChevronRightIcon />
          </Link>
        </Button>
      </div>
      <div className="text-xs text-muted-foreground opacity-0 animate-fade-in-delayed-2s">
        Trusted by more than 1,000 businesses
      </div>
    </main>
  );
}
...
//   return (
//     <div className="border-y-2 relative w-full bg-muted py-20 flex flex-col items-center justify-center px-8 lg:px-0 my-20">
...
//   return (
//     <section className="flex justify-center items-center md:px-32 lg:py-80 mt-10">
//       <div className="flex flex-col lg:flex-row gap-8 lg:gap-40 items-center justify-center max-w-7xl px-4 lg:px-0">
  ...
  return (
    <section className="flex items-center justify-center w-full" id="features">
      <div className="flex flex-col items-center justify-center max-w-7xl space-y-8 w-full py-12 lg:py-40 px-8 lg:px-0">
        ...
        >
          <TabsList className="md:flex grid grid-cols-3 gap-2 md:gap-0 mb-12 md:mb-4">
          ...
          <FeatureContent
            id="Agents"
            title=""
            description="Agents are AI models equipped with a range of tools, from sending emails and creating calendar invites to accessing CRM data. Provide them with the right tools and triggers and they’ll handle tasks for you."
            imageSrc="/images/features/feature-agents.png"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="size-12 rounded-full p-2 text-blue-500 bg-blue-500/20"
              >
                <path d="M12 8V4H8" />
          ...
          <FeatureContent
            id="Triggers"
            title="Triggers to wake up your Agents"
            description="Triggers allow you to run your workflows and AI agents autonomously. From new emails and events to new leads, use triggers to start your agents and automations right when you need them."
            imageSrc="/images/features/feature-triggers.png"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="size-12 rounded-full p-2 text-yellow-500 bg-yellow-500/20"
              >
          ...
          <FeatureContent
            ...
            imageSrc="/images/features/feature-workflows.png"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="size-12 rounded-full p-2 text-green-500 bg-green-500/20"
              >
          ...
          <FeatureContent
            ...
            description="Set up connections to dozens of apps using secure methods like API keys and OAuth2. Every connection is encrypted on the server, ensuring your data stays protected while enabling seamless integrations."
            imageSrc="/images/features/feature-connections.png"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="size-12 rounded-full p-2 text-orange-500 bg-orange-500/20"
              >
          ...
          <FeatureContent
            ...
            imageSrc="/images/features/feature-knowledge.png"
            icon={
              <svg
                xmlns="http://www.w3.org/2000/svg"
                width="24"
                ...
                strokeLinecap="round"
                strokeLinejoin="round"
                className="size-12 rounded-full p-2 text-sky-500 bg-sky-500/20"
              >
                <path d="M12 7v14" />
                <path d="M16 12h2" />
                <path d="M16 8h2" />
...
function FeatureContent({
  ...
  return (
    <TabsContent value={id} className="w-full px-4">
      <div className="flex flex-col lg:flex-row items-center justify-between w-full bg-white overflow-hidden rounded-lg border">
        <div className="flex-1 p-4 sm:p-10 max-w-[500px]">
        ...
        <div className="flex-1 flex items-center justify-center">
          <Image src={imageSrc} width={1000} height={1000} alt={title} />
        </div>
      </div>
    </TabsContent>
  );
...
function HomePricing() {
  return (
    <section
      id="pricing"
      className="bg-background w-full flex flex-col space-y-16 items-center py-12 lg:py-20 px-8 lg:px-0"
    >
