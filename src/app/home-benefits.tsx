...
export function HomeBenefits() {
  return (
    <div className="shadow-md relative -mt-96 xl:-mt-96 w-full bg-muted py-20 flex flex-col items-center justify-center px-8 lg:px-0">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-4 gap-8 max-w-7xl">
        ...
        <BenefitBlock
          ...
          description="We are dedicated to creating a platform that is both intuitive and powerful."
          icon={
            <svg
              width="15"
              height="15"
        ...
        <BenefitBlock
          ...
          description={
            "Our platform is SOC 2 (Type II) compliant, ensuring the highest standards of security and trust for our users."
          }
          icon={
            <svg
              width="24"
