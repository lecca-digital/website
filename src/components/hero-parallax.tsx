...
export const HeroParallax = ({
  ...
  const opacity = useSpring(
    useTransform(scrollYProgress, [0, 0.1, 1], [0.05, 0.8, 1]),
    springConfig
  );
  ...
  return (
    <div className="max-w-full">
      <div className="absolute flex items-center flex-col left-0 right-0 md:py-40 px-4 sm:px-0 p-6 w-full space-y-8 my-20 z-10">
        <div className="max-w-7xl">{children}</div>
      </div>
      <div
        ref={ref}
        className="pt-32 h-[1250px] md:h-[1780px] lg:h-[2350px] overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
      >
        <motion.div
          style={{
            rotateX,
...
export const apps = [
  ...
  },
  {
    ...
    thumbnail: "/apps/todoist.svg",
  },
  {
    title: "Github",
    link: "#",
    thumbnail: "/apps/github.svg",
  },
];
